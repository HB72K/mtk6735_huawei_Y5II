...
static int mt6333_thread_kthread(void *x)
{
    ...
    while (1) {
        ...
        pr_notice( "[INT] int_status_val_2=0x%x\n", int_status_val_2);
...
void MT6333_EINT_SETTING(void)
{
    ...
    //pr_notice( "[CUST_EINT] CUST_EINT_MT6333_PMIC_POLARITY=%d\n",      CUST_EINT_MT6333_PMIC_POLARITY);
    //pr_notice( "[CUST_EINT] CUST_EINT_MT6333_PMIC_SENSITIVE=%d\n",     CUST_EINT_MT6333_PMIC_SENSITIVE);
...
void MT6333_PMIC_INIT_SETTING_V1(void)
{
    ...
    {
        pr_notice( "[MT6333_PMIC_INIT_SETTING_V1] PMIC Chip = %x\n",g_mt6333_cid);
        pr_notice( "[MT6333_PMIC_INIT_SETTING_V1] 20130514\n");
    ...
    {
        pr_notice( "[MT6333_PMIC_INIT_SETTING_V1] Unknown PMIC Chip (%x)\n",g_mt6333_cid);
    }

    pr_notice( "after MT6333 init : Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x\n",
    ...
    // DCT
    pr_notice( "[MT6333_PMIC_INIT_SETTING_V1] pmu_drv_tool_customization_init\n");
...
static int mt6333_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    pr_notice( "[MT6333_PMIC_INIT_SETTING_V1] Done\n");
