 ...
 kal_uint32 charging_parameter_to_value(const kal_uint32 *parameter, const kal_uint32 array_size, const kal_uint32 val)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
    ...
    battery_log(BAT_LOG_FULL, "[%s][MAX8971]gpio_number=0x%x,gpio_mode=%d\n", __func__, gpio_number, gpio_mode);
 ...
 static kal_uint32 charging_enable(void *data)
 {
    ...
    battery_log(BAT_LOG_CRTI, "[%s][MAX8971] charger enable = %d, g_charging_current = %d \r\n", __func__, enable, g_charging_current);
 ...
 static kal_uint32 charging_set_cv_voltage(void *data)
 {
    ...
    /* TO DO */
    battery_log(BAT_LOG_FULL, "[%s][MAX8971] NO Action! \r\n", __func__);
 ...
 static kal_uint32 charging_set_current(void *data)
 {
    ...
    battery_log(BAT_LOG_CRTI, "[%s][MAX8971] current_value = %d,       g_charging_current = %d \r\n", __func__, current_value, g_charging_current);
 ...
 static kal_uint32 charging_set_input_current(void *data)
 {
    ...
    battery_log(BAT_LOG_FULL, "[%s][MAX8971] input_current_value = %d \r\n", __func__, current_value);
 ...
 static kal_uint32 charging_get_charging_status(void *data)
 {
    ...
    *(kal_uint32 *)data = max8971_check_eoc_status();
    ...
    battery_log(BAT_LOG_CRTI, "[%s][MAX8971] EOC_status = %d \r\n", __func__, *(kal_uint32 *)data);
 ...
 static kal_uint32 charging_set_hv_threshold(void *data)
 {
    ...
    battery_log(BAT_LOG_FULL, "[%s][MAX8971] VCDT register_value = %d\r\n", __func__, register_value);
  ...
  static kal_uint32 charging_get_hv_status(void *data)
  {
	   ...
	   *(kal_bool*)(data) = upmu_get_rgs_vcdt_hv_det();
       ...
       battery_log(BAT_LOG_FULL, "[%s][MAX8971] hv_status = %d\r\n", __func__, *(kal_bool*)(data));
 ...
 static kal_uint32 charging_get_charger_det_status(void *data)
 {
	   ...
	   *(kal_bool*)(data) = upmu_get_rgs_chrdet();
       ...
       battery_log(BAT_LOG_FULL, "[%s][MAX8971] g_charger_type = %d\r\n", __func__, g_charger_type);
 ...
 */
 kal_int32 chr_control_interface(CHARGING_CTRL_CMD cmd, void *data)
 {
	 ...
	 {
         battery_log(BAT_LOG_FULL, "[%s][MAX8971] get interface fail!!!\r\n", __func__);
		 return STATUS_UNSUPPORTED;
	 }
