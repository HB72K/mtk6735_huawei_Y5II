...
char puSendCmd[2]={(char)(0xA8),(char)(0x4D)};//2aEO¡¦uAe
    if (i4RetValue < 0) 
    {
        DW9714AFDB("[FM50AF] I2C send failed!! \n");
        return -1;
    }
#else
...
char puSendCmd4[2]={(char)(0xDC),(char)(0x51)};//100Hz,Fastest mode //5b
 ...
 i4RetValue = i2c_master_send(g_pstDW9714AF_I2Cclient, puSendCmd1, 2);	
    if (i4RetValue < 0) 
    {
        DW9714AFDB("I2C send failed!! \n");
        return -1;
    }
 i4RetValue = i2c_master_send(g_pstDW9714AF_I2Cclient, puSendCmd2, 2);
    if (i4RetValue < 0) 
    {
        DW9714AFDB("I2C send failed!! \n");
        return -1;
    }
 i4RetValue = i2c_master_send(g_pstDW9714AF_I2Cclient, puSendCmd3, 2);
    if (i4RetValue < 0) 
    {
        DW9714AFDB("I2C send failed!! \n");
        return -1;
    }
 i4RetValue = i2c_master_send(g_pstDW9714AF_I2Cclient, puSendCmd4, 2);
    if (i4RetValue < 0) 
    {
        DW9714AFDB("I2C send failed!! \n");
        return -1;
