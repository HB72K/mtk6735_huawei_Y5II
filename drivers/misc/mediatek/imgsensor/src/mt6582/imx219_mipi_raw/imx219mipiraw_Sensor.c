...
UINT32 IMX219MIPIOpen(void)
{
    ...
    do {
	   sensorid=(kal_uint16)(((IMX219MIPI_read_cmos_sensor(0x0000))<<8) | IMX219MIPI_read_cmos_sensor(0x0001));  
	   spin_lock(&IMX219_drv_lock);    
  ...
  iPreGain = 0;
	...
	printk("lili>>>>lsc otp load successfully\n");
    return ERROR_NONE;
}
...
UINT32 IMX219MIPIGetSensorID(UINT32 *sensorID) 
{
    ...
    do {		
	   *sensorID =(kal_uint16)(((IMX219MIPI_read_cmos_sensor(0x0000))<<8) | IMX219MIPI_read_cmos_sensor(0x0001)); 
        ...
        SENSORDB("[IMX219MIPI]enter IMX219MIPIGetSensorID sensorID  0x%x\n ",*sensorID);
